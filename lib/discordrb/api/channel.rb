...
module Discordrb::API::Channel
  ...
  def list_thread_members(token, channel_id, before, limit)
    Discordrb::API.request(
      ...
      channel_id,
      :get,
      "#{Discordrb::API.api_base}/channels/#{channel_id}/thread-members",
  ...
  def list_public_archived_threads(token, channel_id, before = nil, limit = nil)
    Discordrb::API.request(
      ...
      channel_id,
      :get,
      "#{Discordrb::API.api_base}/channels/#{channel_id}/threads/archived/public",
      {before: before, limit: limit}.compact,
      authorization: token
    )
  end
  ...
  def list_private_archived_threads(token, channel_id, before = nil, limit = nil)
    Discordrb::API.request(
      ...
      channel_id,
      :get,
      "#{Discordrb::API.api_base}/channels/#{channel_id}/threads/archived/private",
      {before: before, limit: limit}.compact,
      authorization: token
    )
  end
  ...
  def list_joined_private_archived_threads(token, channel_id, before = nil, limit = nil)
    Discordrb::API.request(
      ...
      channel_id,
      :get,
      "#{Discordrb::API.api_base}/channels/#{channel_id}/users/@me/threads/archived/private",
      {before: before, limit: limit}.compact,
      authorization: token
    )
  end
